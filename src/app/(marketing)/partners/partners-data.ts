...
export const PARTNERS: Partner[] = [
  ...
  {
    slug: "mldg-building-design",
    kind: "architect",
    draft: true,
    roleLabel: "Building design studio",
    name: "MLDG Building Design",
    monogram: "ML",
    logo: "/partners/mldg-building-design/logo.png",
    principal: "Lindsay Barrie",
    suburb: "Springwood",
    state: "QLD",
    tagline:
      "A founder-led South East Queensland design studio that stays past the drawings, running the builder tender and administering the contract right through construction.",
    disciplines: ["New homes and renovations", "Townhouse developments", "Tender and contract management"],
    google: { rating: 4.5, reviews: 16 },
    stats: [
      { label: "Google rating", value: "4.5", star: true, sub: "16 reviews" },
      {
      ...
      {
        label: "Builder tenders",
        value: "Managed",
        sub: "plus contract administration",
      },
    ],
    why: "Most building designers hand over a set of drawings and step away at precisely the moment an owner becomes most exposed, the point where a price has to be agreed and a builder has to be held to it. MLDG does the opposite. The studio runs the builder tender for its clients and then administers the contract through construction, so the people who drew the home are still in the room while it is being priced and built. That instinct traces back to founder Lindsay Barrie, who dates his fascination with house design to the age of four and opened MLDG in 2011 by turning a rundown family home into somewhere a young family could properly live. That first client is still with the studio fifteen years on, which tells you much of what you need to know about how it treats people. The team’s own standard is to improve every single thing it touches. For an owner who wants a designer invested well beyond the drawings, this is a genuinely uncommon offer.",
    about:
      "MLDG, the trading name of ML Design Group, is a QBCC-licensed building design studio based at Springwood, south of Brisbane, and led by its founder Lindsay Barrie. The team designs new homes, renovations and extensions, townhouse and multi-residential developments and commercial projects, working across Brisbane, Logan, the Gold Coast and the Sunshine Coast. Each job opens with site checks and pre-design advice before moving into concept development and full construction documentation, with the engineers, certifiers and other specialists a project needs coordinated and the approvals lodged along the way. Recent work spans a stone bathroom renovation at Boronia Heights, a bayside deck and pool at Cleveland, and a townhouse development at Loganholme.",
    facts: {
      established: "2011",
      basedIn: "Springwood, QLD",
      serves: "South East Queensland",
      focus: "Homes, renovations and townhouses",
    },
    website: "https://www.mldg.com.au",
    instagram: "https://www.instagram.com/mldgbuildingdesign/",
    facebook: "https://www.facebook.com/MLDesignGroup",
    linkedin: "https://www.linkedin.com/company/mldg-building-design/",
    galleryUrl: "https://www.mldg.com.au",
    work: [
      {
        title: "Stone bathroom",
        suburb: "Boronia Heights",
        type: "Renovation",
        image: "/partners/mldg-building-design/boronia-heights.jpg",
      },
      {
        title: "Deck and pool at dusk",
        suburb: "Cleveland",
        type: "Renovation",
        image: "/partners/mldg-building-design/cleveland.jpg",
      },
      {
        title: "Townhouse development",
        suburb: "Loganholme",
        type: "Multi-residential",
        image: "/partners/mldg-building-design/loganholme.jpg",
      },
    ],
    joined: "2026",
  },
