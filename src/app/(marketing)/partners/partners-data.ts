...
export const PARTNERS: Partner[] = [
  ...
  {
    slug: "billy-dawson-architects",
    kind: "architect",
    draft: true,
    roleLabel: "Architecture and interior design practice",
    name: "Billy Dawson Architects",
    monogram: "BD",
    logo: "/partners/billy-dawson-architects/logo.png",
    principal: "Billy Dawson",
    suburb: "Toowong",
    state: "QLD",
    tagline:
      "A Toowong architecture and interior design practice that measures itself on client satisfaction rather than peer recognition, and takes on the difficult sites and tight constraints others hedge on.",
    disciplines: ["Residential architecture", "Renovations and extensions", "Interior design"],
    ...
    stats: [
      { label: "Google rating", value: "5.0", star: true, sub: "12 reviews" },
      {
        ...
        value: "18+ yrs",
        sub: "director Billy Dawson",
      },
      {
        label: "Registered with",
        value: "BOAQ",
        sub: "Board of Architects Queensland",
      },
    ],
    why: "There is a line on this practice’s website worth repeating. Their priority, they say, is not to win design awards or impress their peers, but to have you completely satisfied with your home and with the experience of getting there. Coming from an architect, that is an unusual thing to put in writing, and it sets a harder test than a trophy does, because a jury can be persuaded in an afternoon while a client lives with the result for thirty years. Billy Dawson Architects is willing to be measured that way, and so far every client who has rated the practice has given it five stars.\n\nWhat they are quietly very good at is the hard end of the work. The studio actively seeks out the projects others hedge on, the steep or awkward sites, the tight footprints, and the regulatory constraints that quietly reshape a scheme, on the view that the best ideas come from the tightest problems. Billy Dawson brought close to two decades in architecture to the practice he now leads, and the building and everything inside it are resolved by the same hands, so a house arrives as one idea rather than two. The stated aim is a home that still reads well long after the trend that surrounded it has passed. For an owner with a difficult block and no appetite for drama, that is a reassuring combination.",
    about:
      "Billy Dawson Architects opened in the middle of 2019 and works from Toowong, in Brisbane’s inner west. Billy Dawson is registered with the Board of Architects Queensland and studied architecture and design at both the Queensland University of Technology and the University of Queensland. The practice is deliberately boutique, covering architecture and interior design for new homes, renovations and extensions, and it takes work across Brisbane, the Gold Coast, the Sunshine Coast, Ipswich, Toowoomba and rural Queensland, carrying a project from the first sketch through to completion. Recent work includes the Coochin home on acreage, an extension at Currumbin Waters and a house on the Gold Coast canals.",
    facts: {
      established: "2019",
      experience: "18+ yrs",
      basedIn: "Toowong, QLD",
      serves: "Brisbane, Gold Coast and SE Queensland",
      focus: "Homes, renovations and interiors",
    },
    website: "https://www.billydawsonarchitects.com.au",
    instagram: "https://www.instagram.com/billydawsonarchitects/",
    facebook: "https://www.facebook.com/billydawsonarchitects/",
    linkedin: "https://www.linkedin.com/company/billy-dawson-architects-brisbane-architect/",
    galleryUrl: "https://www.billydawsonarchitects.com.au",
    work: [
      {
        title: "Coochin",
        suburb: "Queensland",
        type: "Acreage home",
        image: "/partners/billy-dawson-architects/coochin.jpg",
      },
      {
        title: "Currumbin Waters",
        suburb: "Currumbin Waters",
        type: "Extension",
        image: "/partners/billy-dawson-architects/currumbin-waters.jpg",
      },
      {
        title: "Gold Coast canals",
        suburb: "Gold Coast",
        type: "New home",
        image: "/partners/billy-dawson-architects/gold-coast-canals.jpg",
      },
    ],
    joined: "2026",
  },
  ...
  },
  {
    ...
    why: "Alex spent years in financial advice before broking, much of it in advice remediation with Deloitte, NAB and OCG, the careful work of reviewing where past advice had fallen short and putting it right for clients. He came away knowing exactly what good advice looks like, and it shapes how he lends: start from what a client is really trying to achieve, then find a loan that fits the bigger financial picture rather than tick the box on a single transaction. For an owner financing a build, where the right structure can matter as much as the rate, that planning minded, client-first instinct is what earns him a place in the network.",
  ...
  },
  {
    ...
    why: "Bianca has quietly become one of the more trusted brokers in Melbourne’s north west, and the proof is in the people who keep coming back: more than ninety reviews, every one of them five star. What they single out is that she gets them in. She is a genuine specialist in buying with little or no deposit, guiding first home buyers in particular through the part of lending most find daunting, and she does it with a patience and warmth that turns a stressful process into a manageable one. For an owner financing a build, especially one working hard to pull a deposit together, a broker this trusted, and this good at the hard part of getting finance approved, is exactly who we want beside them.",
