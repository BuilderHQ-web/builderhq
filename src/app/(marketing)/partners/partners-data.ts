...
export const PARTNERS: Partner[] = [
  ...
  },
  {
    ...
    name: "Koda Design",
    monogram: "KD",
    logo: "/partners/koda-design/logo.png",
    principal: "Dane and Rebecca Power",
    suburb: "Brisbane",
    state: "QLD",
    tagline:
      "A Brisbane studio holding building design and interior design under one roof, formed by a husband and wife whose work runs from private homes to the first maths museum in the Southern Hemisphere.",
    disciplines: ["Residential design", "Commercial design", "Interior design"],
    ...
    stats: [
      ...
      },
      {
        ...
        value: "2",
        sub: "building and interior design",
      },
    ],
    why: "In 2023 a Brisbane building designer was handed a brief with no precedent anywhere in this half of the world: give physical form to mathematics. The result was the Mathema Gallery at Ocean View, the first maths museum in the Southern Hemisphere, and it is Dane Power’s work. We raise it not because anyone planning a house needs a museum, but because a brief like that cannot be answered out of habit. It takes someone who thinks hard about what a building is for before deciding what it should look like.\n\nThat instinct is paired with an unusual completeness. Koda is a husband and wife studio, Dane on the building and Rebecca on everything within it, so the outside and the inside of a home are resolved by one practice rather than negotiated between two, and the thinking carries all the way through to the finishes. Dane came to it from years inside major engineering consultancies, which is not the background of a stylist, and every client who has rated the studio has given it five stars. For an owner who wants a home considered properly from the street to the joinery, this is a rare single pair of hands.",
    about:
      "Koda Design is a Brisbane building design and interior design studio formed in 2009 by directors Dane and Rebecca Power. Dane holds a building design qualification from the Canberra Institute of Technology, and Rebecca directs alongside him and runs the studio day to day. The practice works across residential and commercial projects and has built its team in house around a deliberately mixed range of education, experience and talents. Each project is taken on its own merit, weighing context, environment and brief, and traditional design practice is paired with current technology and visualisation so a client can properly see a scheme before it is built. Koda is a member of Building Design Queensland and holds a QBCC building design licence, and its recent work includes Saturn, the Sydney Avenue house and a bayside home at Wellington Point.",
    facts: {
      established: "2009",
      basedIn: "Brisbane, QLD",
      serves: "Brisbane and Queensland",
      focus: "Residential and commercial design",
    },
    website: "https://kodadesign.com.au",
    instagram: "https://www.instagram.com/kodadesign/",
    facebook: "https://www.facebook.com/kodadesign",
    linkedin: "https://www.linkedin.com/company/kodadesignau/",
    galleryUrl: "https://kodadesign.com.au",
    work: [
      {
        title: "Saturn",
        suburb: "Brisbane",
        type: "New home",
        image: "/partners/koda-design/saturn.jpg",
      },
      {
        title: "Sydney Avenue",
        suburb: "Brisbane",
        type: "New home",
        image: "/partners/koda-design/sydney-avenue.jpg",
      },
      {
        title: "Wellington Point",
        suburb: "Wellington Point",
        type: "Interior",
        image: "/partners/koda-design/wellington-point.jpg",
      },
    ],
    joined: "2026",
  },
