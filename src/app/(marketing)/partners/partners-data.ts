...
export const PARTNERS: Partner[] = [
  ...
  {
    slug: "bagnato-architects",
    kind: "architect",
    draft: true,
    roleLabel: "Architecture and interiors practice",
    name: "Bagnato Architects",
    monogram: "BA",
    logo: "/partners/bagnato-architects/logo.png",
    principal: "Dominic and Marie Bagnato",
    suburb: "Melbourne",
    state: "VIC",
    tagline:
      "Luxury homes and interiors across Melbourne, from a practice that designs the building, the rooms inside it and the garden around it.",
    disciplines: ["Luxury new homes", "Architecture and interiors", "Renovations and extensions"],
    institution: {
      name: "Australian Institute of Architects",
      role: "A+ member practice",
      note: "Registered architects · Architects Registration Board of Victoria",
    },
    stats: [
      { label: "Client rating", value: "5.0", star: true, sub: "3 reviews, Houzz" },
      { label: "Established", value: "2007", sub: "principals practising since 1992" },
      { label: "Best of Houzz", value: "6", sub: "design awards, 2014 to 2021" },
    ],
    awards: [
      {
        label: "Best of Houzz for Design, six times",
        sub: "2014, 2015, 2016, 2017, 2020 and 2021",
      },
      {
        label: "Houzz Influencer and Star Houzzer",
        sub: "with more than 100,000 ideabook saves",
      },
    ],
    accolade: {
      label: "The Invisible Architect",
      sub: "Dominic Bagnato’s platform on design and property development, more than 64,000 followers",
      tag: "Since 2023",
    },
    why: "Dominic Bagnato is registered with the Architects Registration Board of Victoria and holds a commercial and domestic builder’s licence, so the person drawing the detail has also built it. He and Marie Bagnato both graduated from the University of Melbourne in 1992, and both practise as A+ members of the Australian Institute of Architects. Two registered architects in one practice, one of them a licensed builder, is an unusual combination, and it shows up as drawings that have already anticipated the site.\n\nThe work carries a signature you can recognise across projects: natural stone, timber and a calm sense of space. Houzz has named them Best of Houzz for design six times between 2014 and 2021, and their houses have been published in magazines and books across Italy, France, Spain, the United States and China. Marie leads the interiors and the landscape, so a house is resolved from the front boundary through to the finishes rather than handed on halfway. For an owner planning something considered in Melbourne, this is a practice that can carry the whole idea.",
    about:
      "Bagnato Architects is an architecture and interiors practice in Melbourne, founded in 2007 by Dominic and Marie Bagnato after more than fifteen years in other private firms. Dominic is director and practice manager, and previously ran Bagnato Marian Guarino Architects. Marie is senior and head project design architect, and worked with Sunpower Design, Neometro Design and Mills Gorman Architects before joining him. The practice covers new homes, renovations and extensions, interiors, landscape and space planning, and stays close to the builder, contractors and suppliers through construction. Recent work includes a travertine house in Keilor and a Moonee Ponds home with an alfresco pavilion and a wine cellar.",
    facts: {
      established: "2007",
      experience: "Since 1992",
      basedIn: "Melbourne, VIC",
      serves: "Melbourne and Victoria",
      focus: "Luxury homes, interiors and renovations",
    },
    website: "https://bagnatoarchitecture.com.au/",
    instagram: "https://www.instagram.com/bagnatoarchitects",
    facebook: "https://www.facebook.com/bagnatoarchitects",
    linkedin: "https://au.linkedin.com/in/dominic-bagnato-architect",
    galleryUrl: "https://bagnatoarchitecture.com.au/",
    work: [
      {
        title: "Keilor residence",
        suburb: "Keilor",
        type: "New home",
        image: "/partners/bagnato-architects/keilor.jpg",
      },
      {
        title: "Moonee Ponds alfresco pavilion",
        suburb: "Moonee Ponds",
        type: "Outdoor living",
        image: "/partners/bagnato-architects/moonee-ponds-alfresco.jpg",
      },
      {
        title: "Moonee Ponds wine cellar",
        suburb: "Moonee Ponds",
        type: "Interior",
        image: "/partners/bagnato-architects/moonee-ponds-cellar.jpg",
      },
    ],
    servicesLabel: "Where they help",
    services: [
      "New homes, architecture and interiors",
      "Renovations, extensions and alterations",
      "Interior design and finishes",
      "Landscape and outdoor rooms",
      "Space planning and documentation",
      "Construction advice from a licensed builder",
    ],
    joined: "2026",
  },
  {
