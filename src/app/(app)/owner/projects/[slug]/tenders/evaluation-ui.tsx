...
function ScopeSection({ ev }: { ev: TenderEvaluation }) {
  ...
  return (
    <DossierSection
      ...
      lede={`${s.included} of ${s.applicable} applicable scope items are included in the price${s.allowance > 0 ? `, ${s.allowance} carried as allowances` : ""}${s.excluded > 0 ? `, ${s.excluded} excluded` : ""}.`}
    >
      <div className="rounded-sm border border-border-subtle bg-surface-1 p-4">
        ...
        <ChipRow label="Excluded scope items" items={s.excludedTrades} tone={TONE.risk} />
