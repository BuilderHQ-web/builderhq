...
export default function Loading() {
  return (
    <div className="px-6 lg:px-10 py-10 lg:py-14 max-w-[1400px] mx-auto">
      {/* Header bones */}
      <div className="flex items-end justify-between gap-4 mb-7">
        <div className="flex flex-col gap-3">
          <Skeleton className="h-3 w-[80px] rounded-sm" />
          <Skeleton className="h-9 w-[260px] rounded-sm" />
          <Skeleton className="h-3.5 w-[440px] rounded-sm" />
        </div>
      ...
      {/* Filter bar */}
      <Skeleton className="h-12 w-full rounded-md mb-7" />
