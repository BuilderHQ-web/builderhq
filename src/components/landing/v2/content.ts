  ...
  homeowner: {
    ...
    spine: {
      head: {
        h2a: "From your plans",
        h2b: "to your builder.",
        lead: "Four steps: scope, price, compare, decide.",
        blurb:
          "Everything happens in one place, and nothing goes out to a builder until you have approved the list.",
      },
      steps: [
        {
  ...
  builder: {
    ...
    spine: {
      head: {
        ...
        h2b: "to the tender you send.",
        lead: "Four steps, and the first one is already done.",
        blurb:
          "The preparation is done before you arrive. You pick the round, walk the list and send one submission.",
      },
      steps: [
        {
          title: "The scope of works",
  ...
  architect: {
    ...
    spine: {
      head: {
        ...
        lead: "Four steps, run under your practice’s name.",
        blurb:
          "Your practice runs the round and keeps the record. Your client answers the open questions, and you put the recommendation in front of them.",
      },
      steps: [
        {
          title: "The scope of works",
