...
export function Footer() {
  return (
    <footer
      className="relative border-t border-border-subtle bg-bg-deep/70 px-5 md:px-10 py-7"
    ...
    >
      ...
      <div className="mx-auto max-w-[1320px] grid grid-cols-1 md:grid-cols-3 gap-5 items-center">
        ...
        <nav className="flex flex-wrap justify-center gap-x-4 sm:gap-x-7 gap-y-1 text-[12px] tracking-[0.04em] text-text-dim">
        ...
        <p className="text-[11px] tracking-[0.18em] uppercase text-text-dim/70 md:justify-self-end text-center md:text-right">
