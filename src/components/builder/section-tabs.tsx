...
export function BuilderSectionTabs({
  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5 p-1.5 rounded-full border border-border-subtle bg-surface-1 shadow-[0_8px_24px_-18px_rgba(15,23,32,0.19)] w-fit">
      {TABS.map((t) => {
        const isActive =
