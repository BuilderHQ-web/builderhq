/**
 * Dev tooling: render the Build Brief Issue 009 OG card (1200×630)
 ...
 * not.
 *
 * Usage: node scripts/gen-og-issue-009.mjs
 */
...
const OUT = path.join(PUB, "og-issue-009.jpg");

const W = 1200;
const H = 630;

const titleLines = ["When one quote", "sets the price."];
...
const svg = `<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="90" y="92" font-family="'Helvetica Neue', Arial, sans-serif" font-size="21" letter-spacing="7" fill="#56c4bb">THE BUILD BRIEF · ISSUE 009</text>
  <text x="90" y="126" font-family="'Helvetica Neue', Arial, sans-serif" font-size="17" letter-spacing="6" fill="#8a97a3">FRIDAY, 4 SEPTEMBER 2026</text>
