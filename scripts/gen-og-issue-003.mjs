/**
 * Dev tooling: render the Build Brief Issue 003 OG card (1200×630)
 ...
 *
 * Usage: node scripts/gen-og-issue-003.mjs
 */
...
const OUT = path.join(PUB, "og-issue-003.jpg");
...
const titleLines = [
  "The cost base restarts, the failure",
  "rate turns, and a 20-day house.",
];
...
const svg = `<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="90" y="92" font-family="'Helvetica Neue', Arial, sans-serif" font-size="21" letter-spacing="7" fill="#56c4bb">THE BUILD BRIEF · ISSUE 003</text>
  <text x="90" y="126" font-family="'Helvetica Neue', Arial, sans-serif" font-size="17" letter-spacing="6" fill="#8a97a3">FRIDAY, 24 JULY 2026</text>
