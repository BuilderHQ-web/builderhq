/**
 * Dev tooling: render the Build Brief Issue 004 OG card (1200×630)
 ...
 *
 * Issue 004's headline is longer than 003's, so the title runs three
 * lines at a smaller size rather than being cut down. The words are
 * the issue's own.
 *
 * Usage: node scripts/gen-og-issue-004.mjs
 */
...
const OUT = path.join(PUB, "og-issue-004.jpg");

const W = 1200;
const H = 630;

const titleLines = [
  "The average new house is declared at",
  "$517,430 before land, and Victoria",
  "resets its workmanship benchmark.",
];
...
const svg = `<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="90" y="92" font-family="'Helvetica Neue', Arial, sans-serif" font-size="21" letter-spacing="7" fill="#56c4bb">THE BUILD BRIEF · ISSUE 004</text>
  <text x="90" y="126" font-family="'Helvetica Neue', Arial, sans-serif" font-size="17" letter-spacing="6" fill="#8a97a3">FRIDAY, 31 JULY 2026</text>
